...
<body>
    <div id="titles">
        ...
        <form action="upload.php" method="POST" enctype="multipart/form-data">
            ...
            <label for="titles">Vyberte soubor k aktualizaci seznamu titulů <i class="fas fa-info" title="File columns format:ADM_REC|SIGNATURA|NAZEV|ISBN|AUTOR"></i></label>
            <br/>
...
<hr/>
    <div id="units">
        ...
        <form action="upload.php" method="POST" enctype="multipart/form-data">
            ...
            <label for="units">Vyberte soubor k aktualizaci seznamu jednotek <i class="fas fa-info" title="File columns format:ADM_REC|unit_id|status|acq_date|update_date"></i></label>
            <br/>
